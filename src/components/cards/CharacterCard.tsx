...
export default function CharacterCard({ character }: CharacterProps) {
	...
	return (
		<div
			className="overflow-hidden transition-all bg-white cursor-pointer shadow-brutal-lg border-brutal active:shadow-none active:translate-x-1 active:translate-y-1 group"
				...
				<div className="flex items-end justify-between mt-3">
					<span
						className={`border-brutal bg-white px-2 py-0.5 text-xs font-bold uppercase ${
							character.status.toLocaleLowerCase() === "alive"
								? "text-green-600"
